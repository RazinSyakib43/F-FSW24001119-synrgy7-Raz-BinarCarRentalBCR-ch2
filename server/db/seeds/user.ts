...
export async function seed(knex: Knex): Promise<void> {
    ...
    await knex("user").insert([
        ...
        { name: "Sakura", email: "sakura@gmail.com", password: "$2a$10$Hejo1bpmhN..QC0EYe9ltOKzQvFztQRS8XsA1uXkIqi/w0SFcsnS.", avatar: "https://res.cloudinary.com/dowiubuw3/image/upload/v1717802244/gutvbvhpgapnheefhf6e.jpg", role: "member", status: "deleted", deleted_at: "2024-05-30 22:27:12", deleted_by: "system"},
        { name: "Sasuke", email: "sasuke@gmail.com", password: "$2a$10$DvtLhwJOe0gtIUNeZB1Bv.kPbYGH8zbawmSVCslu.AlULt48BUO6.", avatar: "https://res.cloudinary.com/dowiubuw3/image/upload/v1717802244/gutvbvhpgapnheefhf6e.jpg", role: "admin", status: "deleted", deleted_at: "2024-05-30 22:27:12", deleted_by: "system"},
        { name: "Kakashi", email: "kakashi@gmail.com", password: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InNhaW56QGdtYWlsLmNvbSIsImlhdCI6MTcxOTU3NjA3NywiZXhwIjoxNzE5NjYyNDc3fQ.gjQ9uVX3UpBFxSWbvpz66rWyZRKtwBaR_wPuGWDdUUI", avatar: "https://res.cloudinary.com/dowiubuw3/image/upload/v1717802244/gutvbvhpgapnheefhf6e.jpg", role: "superadmin", status: "deleted", deleted_at: "2024-05-30 22:27:12", deleted_by: "system"}
    ]);
};
